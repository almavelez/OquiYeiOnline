...
Server = {
  url:
    domain2 +
    "assets/img/index.php?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
  delete:
    domain2 +
    "assets/img/delete.php?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
Email = {
  url:
    domain2 +
    "assets/email/index.php?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
=============================================*/
export let Api = {
  url: "https://oquiyei-online-default-rtdb.firebaseio.com/", // YOUR FIREBASE ENDPOINT
};
...
export let Register = {
  url: "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
export let Login = {
  url: "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
export let SendEmailVerification = {
  url: "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
export let ConfirmEmailVerification = {
  url: "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
export let GetUserData = {
  url: "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
...
export let VerifyPasswordResetCode = {
  url: "https://identitytoolkit.googleapis.com/v1/accounts:resetPassword?key=AIzaSyBkErkjsWttMgT-4VtfzBIdQZ-P-pAGdzo",
};
